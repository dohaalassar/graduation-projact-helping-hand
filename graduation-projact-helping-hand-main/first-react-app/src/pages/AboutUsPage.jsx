      ...
      <main style={{ flex: 1, padding: '40px 20px', maxWidth: '1000px', margin: '0 auto', width: '100%', color: '#000' }}>
        ...
        <section style={{ marginBottom: '70px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', alignItems: 'center' }}>
            <div style={{ flex: '1 1 400px', fontSize: '1.25rem', lineHeight: '1.9', fontWeight: '600' }}>
              بدأنا بهدف مساعدة أولياء الامور والاطمئنان على صحة أطفالهم النفسية ومساعدة الأخصائيين النفسيين على الوصول لأكبر عدد من الحالات خصوصا المحتاجة لتدخل طارئ بعد الحرب على قطاع غزة
            </div>
        ...
        <section style={{ marginBottom: '70px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            <Card text="الأمان لبياناتك و بيانات طفلك" />
        ...
        <section style={{ marginBottom: '70px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            <Card text="نموذج تقييم نشاط القوة و الصعوبات SDQ" />
            <Card text="ألعاب مصممة لفحص صحة طفلك النفسية" />
            <Card text="متابعة الاخصائي النفسي للحالات بحسب الأولوية" />
          </div>
        </section>
        ...
        <section style={{ marginBottom: '70px' }}>
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', justifyContent: 'center', width: '66%', margin: '0 auto' }}>
            ...
            <Card text="السلوك الاجتماعي الايجابي" />
          </div>
        </section>
        ...
        <section style={{ textAlign: 'center', marginBottom: '50px' }}>
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: '1.8', fontWeight: '600', marginBottom: '10px', textAlign: 'right' }}>
            الاطمئنان على صحة طفلك النفسية من خلال موقعنا لا يغني عن الحاجة لزيارة الطبيب أو الاخصائي النفسي. نحن لا نقدم بديلا بل نعزز ايجاد حل أكثر سهولة للوصول اليه في ظل الظروف الراهنة
          </p>
