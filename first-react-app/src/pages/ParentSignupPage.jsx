...
const ParentSignupPage = () => {
  ...
  const validate = () => {
    ...
    if (!formData.emailOrPhone.trim()) newErrors.emailOrPhone = "هذا الحقل مطلوب";
    if (!formData.password.trim()) newErrors.password = "هذا الحقل مطلوب";
  ...
  return (
    <div className="parent-signup-page">
      <AuthLayout>
        <AuthCard title="انشئ حسابك وابدأ رحلتك لمعرفة صحة طفلك النفسية" showBack  fallbackPath="/">
          <form onSubmit={handleSubmit} className="parent-signup-form" noValidate>
            ...
            <PasswordInput
              ...
              hint="أدخل تركيبة تحتوي على الأقل من ستة أرقام وأحرف ورموز"
            />

            <div className="buttons-group">
              <PrimaryButton type="submit">إرسال</PrimaryButton>
              <SecondaryButton type="button">لدي حساب بالفعل</SecondaryButton>
            </div>
          </form>
        </AuthCard>
      </AuthLayout>
